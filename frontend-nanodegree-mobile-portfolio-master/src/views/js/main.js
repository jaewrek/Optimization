...
var resizePizzas = function(size) {
  ...
  function determineDx (elem, size) {
    var domSelector = document.querySelector("#randomPizzas");
    var oldSize = elem.offsetWidth / domSelector.offsetWidth;
    ...
    var dx = (newSize - oldSize) * domSelector.offsetWidth;
  ...
  function changePizzaSizes(size) {
    var domCall = document.getElementsByClassName("randomPizzaContainer");
    var length = domCall.length;
    var dx = determineDx(domCall[0], size);
    var newwidth = (domCall[0].offsetWidth + dx) + 'px';
    for (var i = 0; i < length; i++) {
      domCall[i].style.width = newwidth;
    }
  }
